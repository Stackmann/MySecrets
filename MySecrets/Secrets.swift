...
class Secrets {
    ...
    func loadData() {
        ...
        let fivePass = RecordPass(describe: "Удостоверение", stringFields: ["FirstName":"Eric", "LastName":"Johns", "MiddleName":"Sasha", "SN":"MB"], decimalFields: ["Number": 102030], dateFields: ["RecieveData": date1], avatar: avatarData5, idPattern: "id", num: 5)
